import datetime
from NBPS.Server.Database.SQLManager import DataBase as dB
...
class DB:
    def __init__(self):
        self.player = Player
        self.client = dB("NBPS/Server/Files/players.sqlite")
        self.clubs = dB("NBPS/Server/Files/clubs.sqlite")
    ...
    def get_player_count(self):
        return len(self.client.load_all())

    def get_clubs_count(self):
        return len(self.clubs.load_all())
